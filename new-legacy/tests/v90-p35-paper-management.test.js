...
for(const script of ['paper-import-controller.js','paper-composition-controller.js'])assert(page.includes(script),`paper-management missing ${script}`);
