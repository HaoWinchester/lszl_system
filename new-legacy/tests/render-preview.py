...
with sync_playwright() as p:
    ...
    add(page,'src/87-guided-learning-data.js');add(page,'src/88-guided-learning-store.js');add(page,'src/89-guided-learning-icon-registry.js');add(page,'src/89-guided-learning-app.js')
    ...
    add(page,'src/87-guided-learning-data.js');add(page,'src/88-guided-learning-store.js');add(page,'src/89-guided-learning-activity-registry.js');add(page,'src/89-guided-learning-deep-recall.js');add(page,'src/90-guided-learning-node-app.js')
