...
(function(global){
  ...
  class TaxonomyService{
    ...
    resetAll(){const authority=global.KGReferenceIndexService.permanentDeleteAuthority(this.references);if(!authority.valid)return authority;const result=this.legacy.resetTaxonomies();this.references?.invalidate();return {valid:true,...result,errors:[]}}
