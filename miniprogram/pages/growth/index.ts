...
Component(withPrimaryPanel('growth', withAppearance({
  ...
  onShow() { selectPrimaryTab(this as any, 2); void this.loadGrowth(); },
  ...
  async loadGrowth() {
    ...
    try {
      ...
      this.setData({ summary, view: growthView(summary), selectedGoal: summary.configuredGoal, goalError: '', savedNotice: '' });
