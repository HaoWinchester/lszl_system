...
const existingScripts={
  ...
  'question-bank.html':[
    ...
    'src/teacher/shared/domain-core.js','src/teacher/shared/difficulty-service.js',
    'src/principles/principle-repository.js','src/principles/synthesis-preset-repository.js',
    'src/practice/practice-selection-service.js',
    'src/teacher/question-bank/batch-operation-service.js','src/teacher/question-bank/safe-delete-service.js',
    'src/teacher/question-bank/question-preview.js','src/teacher/question-bank/workspace-layout.js',
    'src/teacher/question-bank/bank-list-controller.js','src/teacher/question-bank/question-list-controller.js',
    'src/teacher/question-editor/question-editor-controller.js','src/teacher/question-classification/question-classification-service.js',
    'src/teacher/training-config/training-config-service.js','src/teacher/training-config/training-preview.js',
    'src/teacher/training-config/training-config-controller.js','src/teacher/training-config/workspace-layout.js',
    'src/teacher/training-config/principle-preset-controller.js',
    'src/teacher/paper-management/paper-list-controller.js','src/teacher/paper-management/paper-category-service.js',
    'src/teacher/paper-management/paper-editor-controller.js','src/teacher/paper-management/paper-question-picker.js',
    'src/teacher/paper-management/paper-preview.js','src/teacher/paper-management/paper-audit-service.js',
    'src/59a-paper-learning-modes.js','src/teacher/paper-management/paper-release-service.js',
    'src/teacher/knowledge-tree/knowledge-tree-adapter.js','src/teacher/association-library/association-library-adapter.js',
    'src/teacher/teacher-domain-registry.js','src/98-teacher-workflow-p2-services.js',
    'src/65-question-bank-admin.js','src/98-question-classification.js','src/97-teacher-question-workflow.js',
    'src/admin/module-help-content.js','src/admin/module-help-controller.js',
  ...
  'paper-management.html':[
    ...
    'src/teacher/knowledge-tree/knowledge-tree-adapter.js','src/teacher/association-library/association-library-adapter.js',
    'src/teacher/teacher-domain-registry.js','src/98-teacher-workflow-p2-services.js',
    'src/98-question-classification.js','src/65-question-bank-admin.js',
    'src/admin/module-help-content.js','src/admin/module-help-controller.js',
