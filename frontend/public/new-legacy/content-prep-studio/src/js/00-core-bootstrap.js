...
5. Keyword v2：关键词必须是词/稳定专业术语，不能是半句话；普通关键词 keywordLevel=normal，核心关键词 keywordLevel=core，并填写 solutionRole、coreReason、sourceType、sourceOptionId 和 locations；每题建议 2～5 个。
...
10. metadata.stemPrincipleIds 保存题干/通用原则；metadata.optionPrincipleMap 保存 A/B/C/D 对应原则；metadata.principleIds 由两者自动汇总。
11. 每道题正确选项必须且只能绑定一条原则；principles 与 synthesisPresets 必须一对一，归纳卡标题固定为“原则：{原则名称}”。
