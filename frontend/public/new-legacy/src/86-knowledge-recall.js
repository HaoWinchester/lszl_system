...
(function(){
  ...
  function saveProgress(){
    if(isRecallReadonly())return;
    const track=(globalThis.KGFeatureAnalytics&&globalThis.KGFeatureAnalytics.track)||function(){};track('recall','key_action','recall_saved');track('recall','outcome','recall_saved');
