...
(function(global){
  ...
  function normalizeNode(node={}){
    ...
    if(nodeType==='synthesis-card'){
      ...
      return {
        ...
        questionId:'',bankId:'',paperId:'',topic:'归纳卡',difficulty:'',stemSummary:'',correctAnswer:'',
  ...
  function normalizeEdge(edge={},index=0){
    ...
    const defaultLabels={same:'同类',contrast:'对比',cause:'因果',exception:'例外',confused:'易混淆',support:'支持',custom:'关联'};
    ...
    return {
      ...
      type,
      label:hasLabel?String(edge.label??''):String(defaultLabels[type]||''),
      color,
      lineStyle,
      pathStyle,
