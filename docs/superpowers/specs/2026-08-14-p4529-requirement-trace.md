...
| 15 | A/B/C 等价等级、diagnosticTarget、L1-L4 | MISSING(G3) | | | | | | |
| 16 | 用途多选 + 人工质量确认 | MISSING(G3) | | | | | | |
| 17 | 从母题创建家族成员 | MISSING(G3) | | | | | | |
| 18 | 家族 JSON 模板 + AI 提示词 | MISSING(G3) | | | | | | |
| 19 | 家族最低覆盖检查 | MISSING(G3) | | | | | | |
| 20 | 家族导航/页签/视觉识别 | MISSING(G3) | | | | | | |
