...
| 做题与验证 | `src/practice/*`、`src/100-practice-mode.js`、`src/103-practice-verification-service.js`、`src/104-practice-learning-orchestrator.js` | `practice-mode.html`、`question-training.html` | `learning_events`、`practice_mistakes`（计划）、`practice_verifications`（计划） | `/api/v1/learning` | 否 | 尝试、错题和验证证据 API 回归；清理浏览器数据后学习记录仍可读取 |
