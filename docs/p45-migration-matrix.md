...
| 做题与验证 | `src/practice/*`、`src/100-practice-mode.js`、`src/103-practice-verification-service.js`、`src/104-practice-learning-orchestrator.js` | `practice-mode.html`、`question-training.html` | `learning_events`、`practice_mistakes`、`practice_verifications` | `/api/v1/learning/practice` | 否 | 尝试、错题、补救、验证证据和学习记录 API 回归；清理浏览器数据后学习记录仍可读取 |
